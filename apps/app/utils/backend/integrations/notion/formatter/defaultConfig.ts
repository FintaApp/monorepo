import { TableConfigs, InstitutionsTableFields, SecurityTableFields, AccountsTableFields, TransactionsTableFields, HoldingsTableFields, InvestmentTransactionsTableFields, CategoryTableFields, INSTITUTION_TABLE_FIELDS, ACCOUNTS_TABLE_FIELDS, TRANSACTIONS_TABLE_FIELDS, HOLDINGS_TABLE_FIELDS, INVESTMENT_TRANSACTIONS_TABLE_FIELDS, SECURITIES_TABLE_FIELDS, CATEGORIES_TABLE_FIELDS } from "~/types/shared/models";
