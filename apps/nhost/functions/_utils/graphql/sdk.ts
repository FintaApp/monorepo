...
export type GetStripeDataQueryVariables = Exact<{
  customerId: Scalars['String'];
}>;


export type GetStripeDataQuery = { __typename?: 'query_root', stripeData: { __typename?: 'StripeData', hasAppAccess: boolean, trialEndsAt: any, customer: { __typename?: 'StripeCustomer', createdAt: any, id: string }, subscription?: { __typename?: 'StripeSubscription', cancelAtPeriodEnd: boolean, currentPeriodEnd: any, currentPeriodStart: any, endedAt?: any | null, id: string, interval: PriceInterval, startedAt: any, status: SubscriptionStatus, trialEndedAt?: any | null, trialStartedAt?: any | null, canceledAt?: any | null } | null } };
...
export type GetUserByCustomerIdQuery = { __typename?: 'query_root', userProfiles: Array<{ __typename?: 'userProfiles', user: { __typename: 'users', id: any, email?: any | null, displayName: string, metadata?: any | null, disabled: boolean, createdAt: any } }> };

export type AllUserFieldsFragment = { __typename: 'users', id: any, email?: any | null, displayName: string, metadata?: any | null, disabled: boolean, createdAt: any };
...
export type GetUserQuery = { __typename?: 'query_root', user?: { __typename: 'users', id: any, email?: any | null, displayName: string, metadata?: any | null, disabled: boolean, createdAt: any } | null };
...
export const DbUserFields = gql`
  ...
  email
    ...
    `;
export const GetStripeData = gql`
...
export const DbUserFieldsFragmentDoc = gql`
  ...
  email
    ...
    `;
export const GetStripeDataDocument = gql`
    query GetStripeData($customerId: String!) {
  stripeData(customerId: $customerId) {
    customer {
      createdAt
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetStripeData(variables: GetStripeDataQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetStripeDataQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetStripeDataQuery>(GetStripeDataDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetStripeData', 'query');
    },
