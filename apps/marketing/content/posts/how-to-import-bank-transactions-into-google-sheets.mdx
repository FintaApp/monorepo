---
  title: How to Import Bank Transactions into Google Sheets
  publishedAt: '2022-10-19'
  image: /images/google-sheets-transactions-table.png
  description: Easily sync your bank account balances, transactions, and investments to Google Sheets
  category: how-to
  integration: google
  hasGenericPost: true
  cta: Ready to start syncing your financial data to Google Sheets?
---
