---
  title: How to Import Bank Transactions into Notion
  publishedAt: '2022-10-19'
  image: /images/notion-transactions-table.png
  description: Easily sync your bank account balances, transactions, and investments to Notion
  category: how-to
  integration: notion
  hasGenericPost: true
  cta: Ready to start syncing your financial data to Notion?
---

Notion is a great tool that can be used to manage your finances. However, manually entering transactions and investments can be tedious. First, you have to check every account at every bank for new transactions. Any accidentally slip-ups can completely turn your budget out of whack . You could try to export your data into csv, but not every bank exports data in the same way.
...
3. Add a destination - Copy one of our many Notion budgeting templates
4. Sit back and relax

That's it! You're now ready to use Notion to track your transactions.