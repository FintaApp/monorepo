...
import { Logger, stripeEventFunctions, graphql, analytics, stripe } from "../_utils";
import { AllUserFieldsFragment } from "../_utils/graphql/sdk";
...
export default async function handler(req: Request, res: Response) {
  ...
  await func({ data, timestamp, user, logger, customer })
  .then(async () => {
